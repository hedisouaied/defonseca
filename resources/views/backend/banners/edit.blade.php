        ...
        <div class="row small-spacing">
            <div class="col-xs-9">
                <div class="box-content card white">
                    <h4 class="box-title">Edit banners</h4>
                    <!-- /.box-title -->
                    <div class="col-md-12">
                        @if ($errors->any())
                    ...
                    <div class="card-content">
                        <form action="{{route('banner.update',$banner->id)}}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Title" value="{{$banner->title}}" name="title">
                            </div>
                            ...
                            <div class="m-t-20">
                                ...
                                <textarea name="description" id="summernote" class="form-control" maxlength="225" rows="2" placeholder="Write some text....">{{$banner->description}}</textarea>
                            </div>

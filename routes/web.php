...
Route::get('product-details/{slug}/', [App\Http\Controllers\Frontend\IndexController::class, 'productDetail'])->name('product.detail');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'admin'], function () {
    ...
    Route::post('category/{id}/child', [\App\Http\Controllers\CategoryContoller::class, 'getChildByParentID']);
